...
\hline
$x$ & $0$ & & \phantom{$\dfrac{10}{3}$} & & $15$ \\
\hline
Signe de $V'(x)$ & & \phantom{$++++$} & $0$ & \phantom{$----$} & \\
\hline
Variations de $V$ & \phantom{$0$} & & & & \phantom{$0$} \\[16pt]
\hline
\end{tabular}
...
\smallskip
Valeur exacte du maximum : $V\!\left(\phantom{\dfrac{10}{3}}\right) = $ \dotfill
