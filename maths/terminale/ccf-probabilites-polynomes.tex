...
\begin{contextebox}
Un menuisier fabrique un bac de rangement ouvert à partir d'une plaque rectangulaire de tôle de 40 cm $\times$ 30 cm. Il découpe un carré de côté $x$ (en cm) à chaque coin, puis plie les bords vers le haut.

Le volume du bac obtenu est :
\[V(x) = x(40 - 2x)(30 - 2x) = 4x^3 - 140x^2 + 1\,200x \quad \text{pour } x \in \;]0\,;\,15[\]
\end{contextebox}
...
\begin{tikzpicture}[scale=0.06]
  % Plaque
  \draw[fill=blue!5, thick] (0,0) rectangle (40,30);
  % Carrés découpés
  \draw[fill=red!10, thick, dashed] (0,0) rectangle (6,6);
  \draw[fill=red!10, thick, dashed] (34,0) rectangle (40,6);
  \draw[fill=red!10, thick, dashed] (0,24) rectangle (6,30);
  \draw[fill=red!10, thick, dashed] (34,24) rectangle (40,30);
  % Lignes de pliage
  \draw[dashed, blue!60] (6,0) -- (6,30);
  \draw[dashed, blue!60] (34,0) -- (34,30);
  \draw[dashed, blue!60] (0,6) -- (40,6);
  \draw[dashed, blue!60] (0,24) -- (40,24);
  % Cotes
  \node[below] at (20,0) {\small 40 cm};
  \node[left] at (0,15) {\small 30 cm};
  \node at (3,3) {\small $x$};
  \node at (20,15) {\small $40-2x$};
\end{tikzpicture}
\end{center}

\textbf{Q1} \comp{REA} — \textbf{À la calculatrice (NumWorks) ou sur GeoGebra}, tracer la courbe de $V$ sur l'intervalle $[0\,;\,15]$. Reproduire ci-dessous l'allure de la courbe obtenue en indiquant les axes et les graduations. \pts{1 pt}
...
\textbf{Q3} \comp{REA} — Calculer la dérivée $V'(x)$. On admettra que $V'(x)$ peut se factoriser sous la forme $V'(x) = 4(3x - 10)(x - 30)$. Résoudre $V'(x) = 0$ sur $]0\,;\,15[$. \pts{1 pt}
...
\textbf{Q4} \comp{ANA} — Dresser le tableau de variations de $V$ sur $]0\,;\,15[$. Calculer la valeur exacte du maximum. Ce résultat confirme-t-il la lecture graphique de Q2 ? \pts{1 pt}
...
\textbf{Q5} \comp{COM} — Conclure : donner la valeur de $x$ qui maximise le volume, le volume maximal, et les dimensions du bac (longueur, largeur, hauteur). Le menuisier juge qu'un bac de plus de 3\,000 cm$^3$ est suffisant. La contrainte est-elle respectée ? \pts{1 pt}
